...
exports.post_routes = [
    { path: '/gpio_value', handler:'gpio_value_post_handler' },
    { path: '/gpio_mode', handler:'gpio_mode_post_handler' }
...
exports.gpio_mode_post_handler = function( req, res ) {
    var mode = req.body.mode;
    var value = req.body.value;
    wpi.digitalWrite(pin, value);
    res.json({result : 'everythings good!'});
};

exports.gpio_value_post_handler = function( req, res ) {
    var pin = req.body.pin;
    var mode = req.body.mode;
    wpi.pinMode(pin, wpi.modes[mode]);
    res.json({result : 'everythings good!'});
